...
* Copy a "feature" from the existing GeoJson. For example,
  ...
  ```
* Edit the GeoJSON to reflect the information about your new point and image. Be sure to include official title and authorial credit in the description of the image. Pkug in the URL for you image as shown below, as well as the decimal degrees for your coordinates.  For example,
